...
| Game logic engines (22) | Complete, 773 tests passing |
| Model wrappers (transformers.js, WebLLM, Ollama proxy) | Complete |
| Core UI shell, world map, onboarding, chapter frame | Complete |
| Per-chapter game canvases | **18 of 22 built** (all of World 1, plus 2-1 through 2-4, all of World 3, 4-1 through 4-3, 5-2 and 5-3) |
